				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
							...
							<h2><font color="black">História teplôt v čase (posledných 100 výsledkov)</font></h2>
								
	  
	  <center><a href="historia_ext.php" class="btn btn-success">Zobraziť všetky záznamy</a></center>	
...
<?php
 	$teploty = mysqli_query($con,"SELECT * FROM vencurik ORDER BY id DESC LIMIT 100") or die(mysqli_error($con));   
  $teploty2 = mysqli_query($con,"SELECT * FROM vencurik ORDER BY id DESC LIMIT 100") or die(mysqli_error($con));   
